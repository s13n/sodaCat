...
def main():
    ...
    common_blocks_dir = output_dir / 'L4'
    ...
    for block_name in sorted(all_blocks.keys()):
        ...
        if len(hashes) == 1:
            ...
            print(f"  + {block_name:20} -> L4 (shared)")
            continue
        ...
        for family_name in STM32L4_FAMILIES:
            if family_name in families_present:
                ...
                family_dir = output_dir / 'L4' / family_name
    ...
    print(f"  Common blocks (L4):     {common_count}")
