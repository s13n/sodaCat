...
function(get_stm32f4_block_path block_name family_or_common output_var)
    if(family_or_common STREQUAL "F4_common")
        set(${output_var} "${STM32F4_MODELS_DIR}/F4_common/${block_name}.yaml" PARENT_SCOPE)
    else()
        set(${output_var} "${STM32F4_MODELS_DIR}/${family_or_common}/blocks/${block_name}.yaml" PARENT_SCOPE)
    endif()
endfunction()
