...
function(get_stm32g4_block_path block_name family_or_common output_var)
    if(family_or_common STREQUAL "G4_common")
        set(${output_var} "${STM32G4_MODELS_DIR}/G4_common/${block_name}.yaml" PARENT_SCOPE)
    else()
        set(${output_var} "${STM32G4_MODELS_DIR}/${family_or_common}/blocks/${block_name}.yaml" PARENT_SCOPE)
    endif()
endfunction()
