...
function(get_stm32l4plus_block_path block_name family_or_common output_var)
    if(family_or_common STREQUAL "L4P_common")
        set(${output_var} "${STM32L4P_MODELS_DIR}/L4P/${block_name}.yaml" PARENT_SCOPE)
    else()
        set(${output_var} "${STM32L4P_MODELS_DIR}/L4P/${family_or_common}/${block_name}.yaml" PARENT_SCOPE)
    endif()
endfunction()
