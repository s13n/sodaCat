...
def main():
    ...
    common_blocks_dir = output_dir / 'F7_common'
    ...
    for block_name in sorted(all_blocks.keys()):
        ...
        all_families = set(STM32F7_FAMILIES.keys())
        ...
        if families_present == all_families:
            ...
            if all_hashes_same:
                ...
                print(f"  + {block_name:20} -> F7_common (shared across all families)")
                continue
    ...
    print(f"  Common blocks (F7_common):     {common_count}")
