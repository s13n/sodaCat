...
function(get_stm32l0_block_path block_name family_or_common output_var)
    if(family_or_common STREQUAL "L0_common")
        set(${output_var} "${STM32L0_MODELS_DIR}/L0_common/${block_name}.yaml" PARENT_SCOPE)
    else()
        set(${output_var} "${STM32L0_MODELS_DIR}/${family_or_common}/blocks/${block_name}.yaml" PARENT_SCOPE)
    endif()
endfunction()
